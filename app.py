...
app = Flask(__name__)
# A linha abaixo foi corrigida para aceitar requisições de qualquer origem
CORS(app, origins="*", expose_headers=['X-Model-Used'])

# (As funções convert_to_wav, parse_audio_mime_type e generate_audio_from_model permanecem as mesmas)
