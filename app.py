...
def generate_audio_endpoint():
    ...
    try:
        ...
        model = genai.GenerativeModel(model_name="gemini-2.5-pro-preview-tts")

        # Montar o prompt com estilo e texto
        full_prompt = f"{style_instructions_text} {text_to_narrate}".strip()
        ...
        # Enviar solicitação de geração de áudio
        ...
        response_json = jsonify({
            ...
            "model_used": "gemini-2.5-pro-preview-tts"
        })
