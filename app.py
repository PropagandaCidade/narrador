...
app = Flask(__name__)
# Configuração do CORS que sabemos que funciona
...
def generate_audio_endpoint():
    """Rota principal que recebe o texto e gera o áudio, com lógica de failover."""
    ...
    try:
        # 1. Tenta gerar com o modelo PRO
        print("Tentando gerar áudio com o modelo: gemini-2.5-pro-preview-tts")
        ...
        if audio_buffer:
            ...
            raise Exception("Buffer de áudio vazio com o modelo Pro.")

    except Exception as e:
        # Se a tentativa com o Pro falhar, verifica se foi por cota esgotada
        if "resource_exhausted" in str(e).lower() or "quota" in str(e).lower():
            ...
            model_to_use = "Flash"
            try:
                # 2. Tenta gerar com o modelo FLASH
                print("Tentando gerar áudio com o modelo: gemini-2.5-flash-preview-tts")
                stream = client.models.generate_content_stream(
                ...
                if audio_buffer:
                    ...
                    raise Exception("Buffer de áudio vazio com o modelo Flash.")
            
            except Exception as e_flash:
                # Se o Flash também falhar, retorna erro
            ...
            # Se a falha do Pro não foi por cota, retorna o erro original
    ...
    # Cria e envia a resposta com sucesso
