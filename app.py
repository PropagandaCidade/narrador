...
def generate_audio_endpoint():
    ...
    try:
        ...
        # --- ALTERAÇÃO PARA VELOCIDADE ---
        # Trocamos o modelo "pro" pelo "flash" para priorizar a velocidade.
        model = "gemini-2.5-flash-preview-tts" # <--- CORREÇÃO APLICADA AQUI
        model_to_use = "Flash" # <--- CORREÇÃO APLICADA AQUI
